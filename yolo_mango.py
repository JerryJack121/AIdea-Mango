...
class YOLO(object):
    _defaults = {
        "model_path":
        'weights/mango_defect/0119/Epoch27-Total_Loss14.9098-Val_Loss8.9659.pth',  #瑕疵部位
        "anchors_path": 'model_data/yolo_anchors_defect.txt',  #瑕疵部位
        "classes_path": 'model_data/defect_classes.txt',  #瑕疵部位
        # "model_path": 'model_data/mango_weight/mango_Epoch42-Total_Loss0.6330-Val_Loss1.8717.pth',  #芒果
        # "anchors_path": 'model_data/yolo_anchors_mango.txt',    #芒果
        # "classes_path": 'model_data/mango_classes.txt',    #芒果
    ...
    def detect_image(self, image):
        ...
        try:
            ...
            return image, class_list, totalmangoxywh
        ...
        for i, c in enumerate(top_label):
            ...
            totalmangoxywh.append(mangoxywh)
